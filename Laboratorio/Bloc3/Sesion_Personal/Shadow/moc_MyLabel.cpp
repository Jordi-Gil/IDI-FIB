...
QT_MOC_LITERAL(1, 8, 6), // "setred"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 1), // "r"
QT_MOC_LITERAL(4, 18, 8), // "setgreen"
QT_MOC_LITERAL(5, 27, 1), // "g"
QT_MOC_LITERAL(6, 29, 7), // "setblue"
QT_MOC_LITERAL(7, 37, 1), // "b"
QT_MOC_LITERAL(8, 39, 9), // "updatered"
QT_MOC_LITERAL(9, 49, 11), // "updategreen"
QT_MOC_LITERAL(10, 61, 10), // "updateblue"
QT_MOC_LITERAL(11, 72, 4) // "send"

    },
    "MyLabel\0setred\0\0r\0setgreen\0g\0setblue\0"
    "b\0updatered\0updategreen\0updateblue\0"
    "send"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->updatered((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->updategreen((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->updateblue((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::setred)) {
                *result = 0;
            }
        }
        {
            typedef void (MyLabel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::setgreen)) {
                *result = 1;
            }
        }
        {
            typedef void (MyLabel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::setblue)) {
                *result = 2;
            }
        }
    }
