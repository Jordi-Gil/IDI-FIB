...
void MyGLWidget::carregaModels(){
    ...
    paths.push_back("../../models/Suelo/Files/CobbleStones2.obj");
    paths.push_back("../../models/fence/grade.obj");
    paths.push_back("../../models/Patricio.obj");
    paths.push_back("../../models/homer.obj");
    paths.push_back("../../models/legoman.obj");
    paths.push_back("../../models/legoman-assegut.obj");
    paths.push_back("../../models/Shaun_Hastings.obj");
    paths.push_back("../../models/cow.obj");
